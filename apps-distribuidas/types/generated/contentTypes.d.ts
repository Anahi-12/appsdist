...
export interface ApiContenidoContenido extends Schema.CollectionType {
  ...
  attributes: {
    ...
    URI: Attribute.Text;
    tipo: Attribute.Enumeration<['VIDEO', 'IMAGE', 'FILE']>;
    suscripcions: Attribute.Relation<
...
export interface ApiSuscripcionSuscripcion extends Schema.CollectionType {
  ...
  attributes: {
    plan: Attribute.Enumeration<['FEE', 'PAID']>;
